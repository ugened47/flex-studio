...
export const CustomerArrow = () => (
  <TransitionArrow className="text-[#F5A623]" />
);

export const ProviderArrow = () => (
  <TransitionArrow className="text-[#BD10E0]" />
);

export const OperatorArrow = () => (
  <TransitionArrow className="text-[#417505]" />
);

export const AutomaticArrow = () => (
...
export const PrivilegedStateIcon = () => (
  ...
  >
    <g fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path
        d="M3 6.494V4.046C3 2.363 4.343 1 6 1s3 1.363 3 3.046V8"
        strokeWidth="1.5"
        fill="none"
      />
    </g>
